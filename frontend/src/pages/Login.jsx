// Login.jsx - Premium Responsive Split-Screen Auth Login Page for BorrowIT
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 sm:px-12 lg:px-20 py-12 relative">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 font-medium">Sign in to your circular community account.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-xs font-bold text-brand-primary hover:underline transition-all">
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="w-full flex items-center gap-3">
            ...
            <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">or continue with</span>
            <div className="flex-1 h-[1px] bg-[#2A2A2D]/60" />
          </div>
          ...
          <p className="text-xs text-slate-500 mt-2 text-center">
            ...
            <Link to="/register" className="font-bold text-brand-primary hover:underline transition-all">
              Sign Up
            </Link>
          </p>
        </motion.div>
